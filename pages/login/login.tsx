                       ...
                       <div className="prose mt-[-2px] w-full dark:prose-invert">
                          <div className="flex flex-row">
                             <div className="prose dark:prose-invert flex-1">
                                <p className="InfoText">I confirm that I have completed the <a className="{Styles.textLink}" href="https://gopagroup.sharepoint.com/sites/GOPAGroup-LearningPlatform/SitePages/GOPA-Group-AI-Chatbot.aspx">GOPA Group AI Training</a> and that I have read and agree with the <a className="{Styles.textLink}" href="https://gopagroup.sharepoint.com/sites/GOPAGroup-LearningPlatform/SitePages/GOPA-Group-AI-Chatbot.aspx">GOPA Group Policy on the Use of Generative AI</a>. 
