      ...
      <div className="flex-1 flex flex-col w-full max-w-sm justify-center gap-2">
        {view === 'check-email' ? (
          ...
          >
            ...
            <div style={{textAlign: 'center', color: '#FECC00', fontSize: '32px', marginBottom: '24px' }}> GOPA Group AI Chatbot </div>
                       ...
                       <div className="prose mt-[-2px] w-full dark:prose-invert">
                          <div className="flex flex-row">
                             <div className="prose dark:prose-invert flex-1">
                                <p className="InfoText">I confirm that I have completed the <a className="{Styles.textLink}" target="_blank" href="https://gopagroup.sharepoint.com/sites/GOPAGroup-LearningPlatform/SitePages/GOPA-Group-AI-Chatbot.aspx">GOPA Group AI Training</a> and that I have read and agree with the <a className="{Styles.textLink}" target="_blank" href="https://gopagroup.sharepoint.com/sites/GOPAGroup-LearningPlatform/SitePages/GOPA-Group-AI-Chatbot.aspx">GOPA Group Policy on the Use of Generative AI</a>. 
